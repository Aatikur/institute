          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{route('branch.deshboard')}}" class="site_title">
                ...
                <img src="{{ asset('web/assets/img/GCLM.png')}}" height="50" style=" width: 90%;">
              </a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ route('branch.payment_request_list') }}"><i class="fa fa-google-wallet"></i> Payment Request </span></a></li>
                </ul>
