   ...
   <div class="inner_wrap">
      <div class="content_holder">
         <div class="innerheading_div">
            <h4>
               <img src="{{  asset('web/assets/img/icon/about.png')}}" width="46" height="45" alt="contact" align="absmiddle">STUDENT ENROLLMENT VERIFICATION
            </h4>
         </div>
         <div class="contact_forms_outer" style="float:left !important;">
            <form action="#" method="post" name="form1" id="form1" class="contact_forms">
               <div class="contact_forms_element">
                  <input name="enrollment" id="enrollment" type="text" Placeholder="Enrollment No." oninvalid="this.setCustomValidity('Please Enter Enrollment No')" required >
                  <span class="error msg_holder"></span>
               </div>
               <div class="contact_forms_element">
                  <input name="name" id="name" type="text" Placeholder="Enter Student Name" oninvalid="this.setCustomValidity('Please Enter Student Name')" required >
                  <span class="error msg_holder"></span>
               </div>
