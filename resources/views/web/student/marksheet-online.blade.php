   ...
   <div class="inner_wrap">
      ...
      <div class="content_holder">
         <div class="innerheading_div">
            <h4>
               <img src="{{  asset('web/assets/img/icon/centers.png')}}" width="46" height="45" alt="contact" align="absmiddle">ONLINE MARKSHEET   
            </h4>
         </div>
         ...
         <div class="contact_forms_outer" style="float:left !important;">
            <form action="{{route('web.marksheet')}}" method="post" name="form1" id="form1" class="contact_forms">
                @csrf
