   ...
   <div class="inner_wrap">
      ...
      <div class="content_holder">
         <div class="innerheading_div">
            <h4>
               <img src="{{  asset('web/assets/img/icon/centers.png')}}" width="46" height="45" alt="contact" align="absmiddle">ONLINE CERTIFICATE   
            </h4>
         </div>
         @if (Session::has('message'))
            <div class="alert alert-success">{{ Session::get('message') }}</div>
         @endif @if (Session::has('error'))
            <div class="alert alert-danger"><strong style="color:red;">{{ Session::get('error') }}</strong></div>
         @endif
         <br />
         <div class="contact_forms_outer" style="float:left !important;">
            <form action="{{route('web.cerificate')}}" method="post" name="form1" id="form1" class="contact_forms">
                @csrf
               <input type="hidden" name="hd" value="val" />
               <div class="contact_forms_element">
                  <input name="enrollment" id="enrollment" type="text" Placeholder="Enrollment No"   oninvalid="this.setCustomValidity('Please Enter Enrollment No')">
               ...
               <div class="contact_forms_element">
                  <input name="dob" id="dob" type="date" Placeholder="Date Of Birth"  oninvalid="this.setCustomValidity('Please Enrter Dob')">
                  <span class="error msg_holder">
                     @if($errors->has('dob'))
                        <span class="invalid-feedback" role="alert" style="color:red">
