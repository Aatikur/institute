   ...
   <div class="inner_wrap">
      <div class="content_holder">
         ...
         <div class="content_details_holder">
            <p>
                Globalfast Computer Literacy Mission (GCLM) is a unit of Globalfast Technology Private Limited. (GCLM) is The Institute of information technology education and development .Globalfast Technology Private Limited Registered as Body Under Govt. Of India (Registration No- 020604). Globalfast Technology Private Limited is also registered NITI Aayog is developing itself as a State-of-the-art Resource Centre, with the necessary resources, knowledge and skills (Registration No–AS/2020/0268943)& Globalfast Technology Private Limited is an ISO 9001:2015 Certified Company by International Accurate Certification for Quality Management System. The Institute has also filled application (Certificate No 6995/QMS/1120).  
            </p>
            <p>
            ...
            <p><strong>NCES FACULTY :</strong> GCLM faculty are full time, Qualified and friendly professionals, always there to guide the students, specially trained to understand students psychology, internalise the knowledge uniformly and put across difficult to understand concept with ease, Thus making students learning ventures smooth and easy. The whole training time is equally divided into theory and practical sessions. A part from regular computer time, students are allowed to utilise unlimited machine time to exercise their mind, boost their creativity and increase their level of curiosity. This builds-up their self confidence, allows them to explore the wide horizon of computer and gradually shapes them into confident professionals.    
            </p>
            <p><strong class="subParagraph">COMPUTER LAB :</strong> GCLM centre have a good computer lab. The computer lab contains high configurations computer networked.     
            </p>
            <p><strong class="subParagraph">OTHER INFRASTRUCTURE :</strong>  Excellent classrooms, other audio-visual teaching learning devices and vast play ground contribute to interactive teaching learning environment and to overall development of the student.              
            </p>
            <p><strong class="subParagraph">INTERACTIVE LEARNING ENVIRONMENT :</strong>  The greatest advantage of GCLM lies in its interactive approach-a concept which stimulates spirit of innovation and self-achievement. The courses give the students, freedom to develop their spirit of innovation and explore the professional world of computers with the guidance of GCLM experienced faculty.
