...
<div id="innerpage_body_holder">
   <div class="inner_wrap">
      <div class="content_holder">
         <h4>
            <img src="assets/img/icon/courses-icon3.png" alt="course" align="absmiddle">COURSES OFFERED (COMPUTER ADVANCE DIPLOMA COURSES)                                            
         </h4>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_holder">
               <tbody>
                  ...
                  <tr class="courses_list">
                     <td align="center" valign="middle"><a href="courses-details.php"><img src="assets/img/icon/courses-icon.png" alt="courses" align="absmiddle"></a></td>
                     <td align="left" valign="middle"><a href="courses-details.php">Advance Diploma in  Information Technology (ADIT)</a></td>
                     <td align="center" valign="middle">GCLM 11</td>
                  </tr>
                  <tr class="courses_list2">
                     <td align="center" valign="middle"><a href="#"><img src="assets/img/icon/courses-icon.png" alt="courses" align="absmiddle"></a></td>
