...
<div id="body_holder">
   ...
   <div class="hme_callnow_outer">
      <div class="inner_wrap">
         <h2>Call Now</h2>
         <div class="hme_callnow"><img src="{{asset('web/assets/img/icon/call.png')}}" height="35" align="absmiddle" alt="call"> Franchise Enquiry: <a href="tel:7002116136" style="color: #fff">+91-7002116136</a></div>
         <div class="hme_callnow"><img src="{{asset('web/assets/img/icon/helpline.png')}}" height="35" align="absmiddle" alt="call"> Helpline: <a href="tel:7002116136" style="color: #fff">+91-7002116136</a></div>
      </div>
   </div>
   <!------------Affiliation start------------>      
